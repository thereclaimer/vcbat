...
internal void
vcbat_gui_build_settings_file_lists() {

    vbat_gui_file_list_render(vcbat_build_settings_window.path_lists.source_files);
    vbat_gui_file_list_render(vcbat_build_settings_window.path_lists.include_directories);
    vbat_gui_file_list_render(vcbat_build_settings_window.path_lists.lib_directories);
    vbat_gui_file_list_render(vcbat_build_settings_window.path_lists.lib_files);
}
